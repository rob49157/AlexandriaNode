...
export namespace Prisma {
  ...
  */
  ...
  export interface UploadDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
     ...
     * 
     * // Only select the `arweaveHash`
     * const uploadWithArweaveHashOnly = await prisma.upload.findMany({ select: { arweaveHash: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Uploads and only return the `arweaveHash`
     * const uploadWithArweaveHashOnly = await prisma.upload.createManyAndReturn({ 
     *   select: { arweaveHash: true },
     *   data: [
     *     // ... provide data here
     *   ]
     * })
  ...
  interface UploadFieldRefs {
    readonly arweaveHash: FieldRef<"Upload", 'String'>
    readonly title: FieldRef<"Upload", 'String'>
    readonly author: FieldRef<"Upload", 'String'>
    readonly category: FieldRef<"Upload", 'String'>
    readonly description: FieldRef<"Upload", 'String'>
    readonly uploader: FieldRef<"Upload", 'String'>
    readonly uploadTimestamp: FieldRef<"Upload", 'DateTime'>
    readonly status: FieldRef<"Upload", 'String'>
    readonly fileSize: FieldRef<"Upload", 'Int'>
    readonly sha256Hash: FieldRef<"Upload", 'String'>
    readonly simHash: FieldRef<"Upload", 'String'>
    readonly litEncryptedKeyId: FieldRef<"Upload", 'String'>
    readonly onChainTxHash: FieldRef<"Upload", 'String'>
  }
  ...
  interface EventFieldRefs {
    ...
    readonly arweaveHash: FieldRef<"Event", 'String'>
  ...
  export type UploadWhereInput = {
    ...
    arweaveHash?: StringFilter<"Upload"> | string
    title?: StringFilter<"Upload"> | string
    author?: StringFilter<"Upload"> | string
    category?: StringFilter<"Upload"> | string
    description?: StringFilter<"Upload"> | string
    uploader?: StringFilter<"Upload"> | string
    uploadTimestamp?: DateTimeFilter<"Upload"> | Date | string
    status?: StringFilter<"Upload"> | string
    fileSize?: IntFilter<"Upload"> | number
    sha256Hash?: StringFilter<"Upload"> | string
    simHash?: StringFilter<"Upload"> | string
    litEncryptedKeyId?: StringFilter<"Upload"> | string
    onChainTxHash?: StringNullableFilter<"Upload"> | string | null
  }

  export type UploadOrderByWithRelationInput = {
    arweaveHash?: SortOrder
    title?: SortOrder
    author?: SortOrder
    category?: SortOrder
  ...
  export type UploadScalarWhereWithAggregatesInput = {
    ...
    arweaveHash?: StringWithAggregatesFilter<"Upload"> | string
    title?: StringWithAggregatesFilter<"Upload"> | string
    author?: StringWithAggregatesFilter<"Upload"> | string
    category?: StringWithAggregatesFilter<"Upload"> | string
    description?: StringWithAggregatesFilter<"Upload"> | string
    uploader?: StringWithAggregatesFilter<"Upload"> | string
    uploadTimestamp?: DateTimeWithAggregatesFilter<"Upload"> | Date | string
    status?: StringWithAggregatesFilter<"Upload"> | string
    fileSize?: IntWithAggregatesFilter<"Upload"> | number
    sha256Hash?: StringWithAggregatesFilter<"Upload"> | string
    simHash?: StringWithAggregatesFilter<"Upload"> | string
    litEncryptedKeyId?: StringWithAggregatesFilter<"Upload"> | string
    onChainTxHash?: StringNullableWithAggregatesFilter<"Upload"> | string | null
  }
  ...
  export type EventWhereInput = {
    ...
    arweaveHash?: StringFilter<"Event"> | string
  ...
  export type EventScalarWhereWithAggregatesInput = {
    ...
    arweaveHash?: StringWithAggregatesFilter<"Event"> | string
  ...
  export type UploadUpdateInput = {
    arweaveHash?: StringFieldUpdateOperationsInput | string
    ...
    simHash?: StringFieldUpdateOperationsInput | string
    litEncryptedKeyId?: StringFieldUpdateOperationsInput | string
